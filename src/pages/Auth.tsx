...
import { Home, Mail, Lock, Phone, User, Building, Users, Loader2, Eye, EyeOff } from "lucide-react";
import { z } from "zod";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (mode === "signup") {
        ...
        const { error } = await signUp(email, password, { fullName, role, phone: formattedPhone });
